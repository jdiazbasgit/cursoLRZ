...
let paisesRecibidos = [];
let divContenido = document.querySelector("#contenido")(divContenido).innerHTML = "";
...
(_a = document.querySelector("#continente")) === null || _a === void 0 ? void 0 : _a.addEventListener("change", () => {
    ...
    paises.getDatos("https://restcountries.com/v3.1/region/" +
        ...
        datos.sort((a, b) => {
            return a.translations.spa.name.common.localeCompare(b.translations.spa.name.common);
        });
        datos.forEach((pais) => {
            var _a, _b, _c, _d;
        ...
        (_a = document.querySelector("#paises")) === null || _a === void 0 ? void 0 : _a.addEventListener("change", () => {
            ...
            paises.getDatos("https://restcountries.com/v3.1/name/" +
                selectPaises
            //evento click del boton generales
            , 
            //evento click del boton generales
